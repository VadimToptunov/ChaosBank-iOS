...
nonisolated enum DefectRegistry {
    ...
    static let all: [Defect] = [
        ...
        Defect(id: .loanAprUnderstated, title: "Loan APR understated vs the rate charged",
               feature: "Loans", category: .money, severity: .critical,
               violates: "The advertised APR equals the rate used to compute the monthly payment.",
               flakiness: .deterministic),
