...
EXCLUDE='View\.swift$|ChaosBankApp|ChaosBankScreen|AuthViews|WebLoginView|Components\.swift|Sparkline|LiveTicker|A11y\.swift|Colors\.swift|BuildBadge|LivePriceService|UIKit'
